...
class Index extends Component {
    ...
    render() {
        ...
        let DropDownData = this.state.dropDown.map((x) => {
            return (
                <li>
                    {x.data}
                </li>
        ...
        let { AddNewData } = this.props;

        var OwlCarouselList = AddNewData && AddNewData.length > 0 && AddNewData.map((element, key) => {
            return (


                <div className="col-lg-3 col-md-4 col-sm-6 col-12 pb-3">
                                ...
                                <div className="col-sm-6 cardgrid__dot" onClick={(e) => this.openDropDown(e)}>
                                    <Dropdown>
                                        ...
                                        <div classname="dropDowns">
                                            <Dropdown.Menu >
                                                <Dropdown.Item > {DropDownData}</Dropdown.Item>
