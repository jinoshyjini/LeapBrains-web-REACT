                        ...
                        <div className='add-event'>
                            <div className='event-border'>
                                <form className='event-box' onSubmit={this.handleSubmit}>
                                    ...
                                    <div className='ev-r1 '>
                                        <input type="text" name="title" value={this.state.title} onChange={this.handleChange} id='ev-formtitle' placeholder='Title' />
                                    </div>
                                    <div className='ev-r2'>
                                        <label>Plan:</label>
                                        <select name="plan" id="ev-select">
                                            <option value="">Going to Cambridge</option>
                                        </select>
                                    </div>
                                    <div className='ev-r3'>
                                        <label>Course:</label>
                                        <select name="course" id="ev-select">
                                            <option value="">Algebra</option>
                                        </select>
                                    </div>
                                    <div className='ev-r4'>
                                        <label>Milestone:</label>
                                        <select name="milestone" id="ev-select">
                                    ...
                                    <div className='ev-r5 ev-ro'>
                                        ...
                                        <select name="advisor" value={this.state.advisor} onChange={this.handleChange} id="ev-advisor">
                                    ...
                                    <div className='ev-r6 '>
                                        <div className='date'>
                                            ...
                                            <input type="text" name="date" id='ev-date' placeholder='Select date' onChange={this.handleChange} onFocus={(e) => (e.target.type = "date")}
                                        ...
                                        <div className='time'>
                                            ...
                                            <input type="text" name="time" id='ev-time' placeholder='Select time' onChange={this.handleChange} onFocus={(e) => (e.target.type = "time")}
                                                onBlur={(e) => (e.target.type = "text")} />
                                        </div>
                                    </div>
                                    <div className='ev-r7'>
