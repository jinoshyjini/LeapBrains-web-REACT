...
class Index extends Component {
    ...
    render() {
        ...
        return (
            <>
                <div className="set_initial_plan full-height">
                    <div className="vertical-center height-75">
                        <div className="container full-height">
                            <div className="initial_plan">
                                <h1 className="login_title text-center">Set up your initial plan</h1>
                                <div className="row">
                            ...
                            <div className="footer">
                                <div className="row m-0">
                                    <div className="footer__left col-md-4 col-sm-4 col-4 text-center p-0">
                                        <p>
                                            <Link to="/Sendinvites" className="footer__left__cta">
                                    ...
                                    <div className="footer__center col-md-4 col-sm-4 col-4 text-center">
                                        <p>5 out of 5 steps</p>
                                    </div>
                                    <div className="footer__right col-md-4 col-sm-4 col-4 text-center">
                                        <Link className="footer__cta" to="/SelectAdvisor">Next step</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
